        ...
        <div className="card about-section">
            ...
            <div style={{ marginBottom: '24px' }}>
                <p style={{ marginBottom: '16px' }}>
                    ...
                    As any employee, to ensure quality and consistency, it follows a detailed and documented <a href="https://github.com/Edouard-Legoupil/unhcr_stat_copilot/blob/main/terms_of_reference_and_sop_unhcr.md" target="_blank" rel="noopener noreferrer"><strong>Standard Operating Procedure</strong></a> that describes in a transparent way how it works.
                    More than the model behind, that can be replaced based on a cost-efficiency calculation, those agentic componnents are where the real capacity of the assistant lies. </p>
                <p style={{ marginBottom: '16px' }}>
