        ...
        <div className="card about-section">
            ...
            <div style={{ marginBottom: '24px' }}>
                ...
                <ul style={{ paddingLeft: '20px' }}>
                    ...
                    <li>You can <strong>transparently review</strong> and <a href="https://github.com/Edouard-Legoupil/unhcr_stat_copilot/blob/main/docs/LEARN.md" target="_blank" rel="noopener noreferrer" data-testid="github-link">learn</a> from the  <a href="https://github.com/edouard-legoupil/unhcr_stat_copilot/" target="_blank" rel="noopener noreferrer" data-testid="github-link">source code</a> and share comments and suggestions through <a href="https://github.com/Edouard-Legoupil/unhcr_stat_copilot/issues/new" target="_blank" rel="noopener noreferrer" data-testid="github-link">GitHub Issues</a></li>
                    ...
                    <li>Send an email to the assistant developper (<i>aka supervisor...</i>): <a href="mailto:legoupil@unhcr.org" target="_blank" rel="noopener noreferrer" data-testid="github-link">legoupil@unhcr.org</a> if you have more extensive feedback</li>
                </ul>
            </div>
