        ...
        <div className="card about-section">
            ...
            <div style={{ marginBottom: '24px' }}>
                <p style={{ marginBottom: '16px' }}>
                    This assistant provides statistical analysis and insights <strong>strictly based on UNHCR data</strong> and previously published reports and analyses. As such, the resulting output could be potentially created by any analyst working for Donors, Governments or Medias. It also means the content generated can be used in official and public capacity, but it remains the responsibility of the user to ensure its accuracy and appropriateness as it does not replace existing reporting lines and review processes.
                    As any employee, to ensure quality and consistency, the assistant follows a detailed and documented <a href="https://github.com/Edouard-Legoupil/unhcr_stat_copilot/blob/main/terms_of_reference_and_sop_unhcr.md" target="_blank" rel="noopener noreferrer"><strong>Standard Operating Procedure</strong></a> that describes in a transparent way how it works.
