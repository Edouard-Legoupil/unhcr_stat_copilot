export default function Header() {
    ...
    return (
        ...
        >
            ...
            <h3>⚠️ Beta Version  V0.1 - for Testing Purpose - Once validated, this assistant will be integrated in the AI proposal drafting app, built by DER.  ⚠️</h3>
            <p>A Collaborative Virtual Assistant to generate Forced Displacement <b>Insights</b> carefully crafted for specific usages: Briefing Kit, Donors Proposals or Medias Post
                ...
                <b> |</b> Powered by a <b>Model Context Protocol</b> AI Server and UNHCR Standard Data Visualisation Tools</p >
